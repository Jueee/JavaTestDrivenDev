...
public class Location {
	...
	public boolean forward() {
		return move(FORWARD, new Point(100, 100), new ArrayList<Point>());
	}
	...
	public boolean backward() {
		return move(BACKWARD, new Point(100, 100), new ArrayList<Point>());
	}

	public boolean backward(Point max) {
		return move(BACKWARD, max, new ArrayList<Point>());
	}
